        ...
        <section id='fruit-tea'>
            <div className='container device-computer'>
                <div className="row fruit-tea">
                    ...
                    <div className="col-xl-6 col-lg-6 fruit-tea-content">
                        <div>
                    ...
                    <div className="col-lg-5 col-xl-5 fruit-tea-image-area">
            ...
            <div className='container-fluid device-mobile'>
                <div className="fruit-tea">
                    <div className="fruit-tea-label-area">
                        <h1 className='fruit-tea-label'>FRUIT TEA</h1>
                    </div>
                    <div className="fruit-tea-image-area">
                        <img className='menu-image' src={Img} alt="" />                        
                    </div>

                    <div className="col-sm-12 col-md-12 fruit-tea-content">
                        <div>
                            <div className='product-label'>
                                <p className='product-name'>Manila mango</p>
                                <div className='menu-dash mt-2 mx-1'></div>
