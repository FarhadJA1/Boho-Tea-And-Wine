        ...
        <section id='salads'>
            <div className='container device-computer'>
                <div className="row salads">
                    ...
                    <div className="col-xl-6 col-lg-6 salads-content">
                    ...
                    <div className="col-lg-5 col-xl-5 salads-image-area">
            ...
            <div className='container-fluid device-mobile'>
                <div className="salads">
                    <div className="salads-label-area">
                        <h1 className='salads-label'>SALADS</h1>
                    </div>
                    <div className="salads-image-area">
                        <img className='menu-image' src={Img} alt="" />                       
                    </div>
                    <div className="salads-content">
                        <div className='product-label'>
                            <p className='product-name'>Greek salad</p>
                            <div className='menu-dash mt-2 mx-1'></div>
                            <p className='product-price'>7₼</p>
